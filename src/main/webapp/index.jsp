...
<head>
	...
	<link rel="stylesheet" href="<c:url value='resources/css/slide-down-box-menu-style.css'/>" type="text/css">
	...
	<link rel="stylesheet" href="<c:url value='resources/application/components/admin_home/home.css'/>" type="text/css">
	<link rel="stylesheet" href="<c:url value='resources/css/admin/metisMenu.min.css'/>" type="text/css">
	<link rel="stylesheet" href="<c:url value='resources/css/admin/morris.css'/>" type="text/css">
	<link rel="stylesheet" href="<c:url value='resources/css/admin/sb-admin-2.css'/>" type="text/css">
	<link rel="stylesheet" href="<c:url value='resources/css/admin/timeline.css'/>" type="text/css">
	
	<!-- Link To Customer -->
    <link rel="stylesheet" href="<c:url value='resources/application/components/header-page/header-page.css'/>" type="text/css">
	<script>
